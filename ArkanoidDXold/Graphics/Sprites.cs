...
namespace ArkanoidDX.Graphics
{
    public static class Sprites
    {
        ...
        public static ArkanoidDX Game;

        public static Sprite BrkFlash
        {
            get { return new Sprite(Game, 6, new TimeSpan(0, 0, 0, 0, 100), AnimationState.Stop, Textures.BrkFlash); }
        }
        public static Sprite BrkTeleport
        {
            get { return new Sprite(Game, 6, new TimeSpan(0, 0, 0, 0, 100), AnimationState.LoopPlay , Textures.BrkTeleport); }
        }
        public static Sprite BrkTransmit
        {
            get { return new Sprite(Game, 10, new TimeSpan(0, 0, 0, 0, 100), AnimationState.LoopPlay, Textures.BrkTransmit); }
        }

        public static Sprite EnmOrb
        {
            get { return new Sprite(Game, 24, new TimeSpan(900000), AnimationState.LoopPlay, Textures.EnmOrb); }
        }

        public static Sprite EnmGeom
        {
            get { return new Sprite(Game, 10, new TimeSpan(900000), AnimationState.LoopPlay, Textures.EnmGeom); }
        }

        public static Sprite EnmTri
        {
            get { return new Sprite(Game, 11, new TimeSpan(900000), AnimationState.LoopPlay, Textures.EnmTri); }
        }

        public static Sprite EnmUfo
        {
            get { return new Sprite(Game, 8, new TimeSpan(900000), AnimationState.LoopPlay, Textures.EnmUfo); }
        }
        public static Sprite EnmBlob
        {
            get { return new Sprite(Game, 6, new TimeSpan(900000), AnimationState.LoopPlay, Textures.EnmBlob,0.75f); }
        }
        public static Sprite EnmOrbRed
        {
            get { return new Sprite(Game, 24, new TimeSpan(900000), AnimationState.LoopPlay, Textures.EnmOrbRed); }
        }
        public static Sprite EnmOrbGreen
        {
            get { return new Sprite(Game, 24, new TimeSpan(900000), AnimationState.LoopPlay, Textures.EnmOrbGreen); }
        }
        public static Sprite EnmOrbBlue
        {
            get { return new Sprite(Game, 24, new TimeSpan(900000), AnimationState.LoopPlay, Textures.EnmOrbBlue); }
        }

        public static Sprite EnmDohSplinter
        {
            get { return new Sprite(Game, 12, new TimeSpan(450000), AnimationState.LoopPlay, Textures.EnmDohSplinter); }
        }

        public static Sprite EnmDieOrbTri
        {
            get { return new Sprite(Game, 6, new TimeSpan(0, 0, 0, 0, 100), AnimationState.Play, Textures.EnmDieOrbTri); }
        }

        public static Sprite EnmDieGeomUfo
        {
            get { return new Sprite(Game, 7, new TimeSpan(0, 0, 0, 0, 100), AnimationState.Play, Textures.EnmDieGeomUfo); }
        }

        public static Sprite PwrSlowS
        {
            get { return new Sprite(Game, 8, new TimeSpan(0, 0, 0, 0, 100), AnimationState.LoopPlay, Textures.PwrSlowS); }
        }

        public static Sprite PwrCatchC
        {
            get { return new Sprite(Game, 8, new TimeSpan(0, 0, 0, 0, 100), AnimationState.LoopPlay, Textures.PwrCatchC); }
        }

        public static Sprite PwrExpandE
        {
            get { return new Sprite(Game, 8, new TimeSpan(0, 0, 0, 0, 100), AnimationState.LoopPlay, Textures.PwrExpandE); }
        }

        public static Sprite PwrDisruptD
        {
            get { return new Sprite(Game, 8, new TimeSpan(0, 0, 0, 0, 100), AnimationState.LoopPlay, Textures.PwrDisruptD); }
        }

        public static Sprite PwrLaserL
        {
            get { return new Sprite(Game, 8, new TimeSpan(0, 0, 0, 0, 100), AnimationState.LoopPlay, Textures.PwrLaserL); }
        }

        public static Sprite PwrExitB
        {
            get { return new Sprite(Game, 8, new TimeSpan(0, 0, 0, 0, 100), AnimationState.LoopPlay, Textures.PwrExitB); }
        }

        public static Sprite PwrLifeP
        {
            get { return new Sprite(Game, 8, new TimeSpan(0, 0, 0, 0, 100), AnimationState.LoopPlay, Textures.PwrLifeP); }
        }

        public static Sprite PwrReduceR
        {
            get { return new Sprite(Game, 8, new TimeSpan(0, 0, 0, 0, 100), AnimationState.LoopPlay, Textures.PwrReduceR); }
        }

        public static Sprite PwrMegaBallH
        {
            get { return new Sprite(Game, 8, new TimeSpan(0, 0, 0, 0, 100), AnimationState.LoopPlay, Textures.PwrMegaBallH); }
        }

        public static Sprite PwrFastF
        {
            get { return new Sprite(Game, 8, new TimeSpan(0, 0, 0, 0, 100), AnimationState.LoopPlay, Textures.PwrFastF); }
        }

        public static Sprite PwrIllusionI
        {
            get { return new Sprite(Game, 8, new TimeSpan(0, 0, 0, 0, 100), AnimationState.LoopPlay, Textures.PwrIllusionI); }
        }

        public static Sprite PwrOrbitO
        {
            get { return new Sprite(Game, 8, new TimeSpan(0, 0, 0, 0, 100), AnimationState.LoopPlay, Textures.PwrOrbitO); }
        }

        public static Sprite PwrTwinT
        {
            get { return new Sprite(Game, 8, new TimeSpan(0, 0, 0, 0, 100), AnimationState.LoopPlay, Textures.PwrTwinT); }
        }

        public static Sprite PwrRandom
        {
            get { return new Sprite(Game, 16, new TimeSpan(0, 0, 0, 0, 100), AnimationState.LoopPlay, Textures.PwrRandom); }
        }

        public static Sprite PwrMegaLaserM
        {
            get { return new Sprite(Game, 8, new TimeSpan(0, 0, 0, 0, 100), AnimationState.LoopPlay, Textures.PwrMegaLaserM); }
        }

        public static Sprite PwrElectricFence
        {
            get { return new Sprite(Game, 8, new TimeSpan(0, 0, 0, 0, 100), AnimationState.LoopPlay, Textures.PwrElectricFence); }
        }
        
        public static Sprite FrmTopOpen
        {
            get { return new Sprite(Game, 6, new TimeSpan(900000), AnimationState.Pause, Textures.FrmTopOpen); }
        }

        public static Sprite FrmSideOpen
        {
            get { return new Sprite(Game, 6, new TimeSpan(900000), AnimationState.Pause, Textures.FrmSideOpen); }
        }

        public static Sprite FrmSideWarpOpen
        {
            get { return new Sprite(Game, 6, new TimeSpan(900000), AnimationState.Pause, Textures.FrmSideWarpOpen); }
        }

        public static void LoadContent(ArkanoidDX game, ContentManager content)
        {
            Game = game;
            ...
            VaExplode = new Sprite(Game, 5, new TimeSpan(0, 0, 0, 0, 100), AnimationState.LoopPlay, Textures.VaExplode);
            ...
            CmnElectricFence = new Sprite(Game, 4, new TimeSpan(500000), AnimationState.LoopPlay, Textures.CmnElectricFence);
