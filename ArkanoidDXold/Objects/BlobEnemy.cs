...
namespace ArkanoidDX.Objects
{
    ...
    public class BlobEnemy : Enemy
    {
        ...
        public BlobEnemy(ArkanoidDX game, PlayArena playArena, Sprite texture, Sprite dieTexture, Vector2 location):base(game,playArena,texture,dieTexture,location)
        {
            ...
            {
                Motion = location.X > PlayArena.TopRightEntry.Location.X+PlayArena.TopRightEntry.Texture.Width ? new Vector2(-1, 0) : new Vector2(1, 0);
            }
        }
            ...
            foreach (var b in PlayArena.LevelMap.BrickMap)
            {
                ...
                switch(c)
                {
                    ...
                    case CollisionPoint.BottomRight:
                        Motion = new Vector2(Motion.X*-1f, Motion.Y*-1f);
                        Location = new Vector2(Location.X, b.Bounds.Bottom);
                        break;
