...
namespace ArkanoidDXUniverse.Arena
{
    public class BaseArena : IDrawable, ILocatable
    {
        ...
        public Rectangle Bounds => Game.ArenaArea;
        ...
        public Vector2 Center => new Vector2(Game.ArenaArea.Center.X, Game.ArenaArea.Center.Y);

        public float Width => Game.ArenaArea.Width;
        public float Height => Game.ArenaArea.Height;
